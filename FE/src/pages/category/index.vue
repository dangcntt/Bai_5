                        ...
                        <div class="col-lg-9 mb-2">
                          <div class="row">
                              ...
                              <div class="cs-title-box">
                                <div class="cs-title py-2 mb-4" style="padding-top: 7px !important;">
                                  <a href="">
                                    ...
                                    <span style="color: #fff; font-size: 16px;" v-if="this.menu != null && this.menu.name != null">
                                      {{this.menu.name }}
                                    </span>
                                  </a>
                                </div>
                                      ...
                                      <div class="col-md-12 mb-4">
                                        <b-card no-body class="card-box">
                                          <b-row no-gutters class="align-items-center card-intro">
                                            <span v-for ="(item,index) in item.menu" :key="index" class="card-info">
                                              <div v-if="index === 0">{{ menuName }}</div>
                                            </span>
                                            <b-col md="3">
                                              <router-link
                                                    :to="{
                                            ...
                                            <b-col md="9" style="padding: 10px;" class="title-category">
                                              <router-link
                                                    :to="{                                                        
                                                        path: `/bang-tin/chi-tiet/${item._id}`,
                                                        query: { menuId: menuId}
                            ...
                            <div class="col-lg-12" v-else>
                              <div class="col-md-12 mt-3 noidung" style="font-size: 14px; text-align: justify;">
